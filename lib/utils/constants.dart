...
class Constants {
  ...
  static const List<String> VALID_IMAGES_EXTENTIONS = ['png', 'jpg', 'heif', 'hevc', 'jpeg', 'h.264', 'mpeg-4'];

  static const String STORE_TYPE_FWMP = 'FWMP';
