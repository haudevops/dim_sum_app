...
import 'package:dim_sum_app/base/base_response.dart';
...
import 'package:dim_sum_app/utils/logs/logger_interceptor.dart';
  ...
  BaseService._internal() {
    ...
    dio.interceptors
      ...
      if (token != null) {
        ...
        options.headers['source'] = Constants.SOURCE_APP;
      }
